...
public class Chessboard extends JComponent {
    ...
    public void initAllChessOnBoard() {
        ...
        if(count != 0){
            ...
            ChessGameFrame.scoreLabel.setText(String.format("%d : %d", blackPoints,redPoints));
            ChessGameFrame.scoreLabel1.setText("0");
            ChessGameFrame.scoreLabe.setText("0");
            ChessGameFrame.scoreLabl.setText("0");
            ChessGameFrame.scoreLael.setText("0");
            ChessGameFrame.scoreLbel.setText("0");
            ChessGameFrame.scoreabel.setText("0");
            ChessGameFrame.scorLabel.setText("0");

            ChessGameFrame.scoreLab.setText("0");
            ChessGameFrame.scoreLa.setText("0");
            ChessGameFrame.scoreLb.setText("0");
            ChessGameFrame.scoreab.setText("0");
            ChessGameFrame.scorLab.setText("0");
            ChessGameFrame.scoeLab.setText("0");
            ChessGameFrame.screLab.setText("0");
            clickController.saver.endgame();
        }
        count ++;
    ...
    public void loadGame(List<String> chessData) {
        ...
        clickController.saver.loadGameFromProcedure2();
    }
    ...
    public void endGame() {
        if (redPoints >= 60) {
            int i = JOptionPane.showConfirmDialog(null,"是否再来一局？","红方赢了！",JOptionPane.YES_NO_OPTION);
            if(i == 0){
                initAllChessOnBoard();
            }
            else if (i == 1) {
                new MainFrame(747,350).setVisible(true);
            }
        }
        if(blackPoints >= 60){
            int i = JOptionPane.showConfirmDialog(null,"是否再来一局？","黑方赢了！",JOptionPane.YES_NO_OPTION);
            if(i == 0){
                initAllChessOnBoard();
            }
            else if (i == 1) {
